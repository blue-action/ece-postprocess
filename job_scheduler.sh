...
do
  ...
  cp ICMGGECE3+${year}${month[${c_month}]} /projects/0/blueactn/reanalysis/temp/ICMGGECE3+${year}${month[${c_month}]}
  cdo sp2gpl ICMSHECE3+${year}${month[${c_month}]} /projects/0/blueactn/reanalysis/temp/ICMSHECE3+${year}${month[${c_month}]}
  ...
  python AMET_land_surface.py < ./input.txt
  # record
  echo 'year and month'${year}${month[${c_month}]} >> log_time.log
  date >> log_time.log
  # remove the temporary file
  rm /projects/0/blueactn/reanalysis/temp/ICMSHECE3+${year}${month[${c_month}]}
  rm /projects/0/blueactn/reanalysis/temp/ICMGGECE3+${year}${month[${c_month}]}
